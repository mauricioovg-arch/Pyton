...
class GestorNotificaciones:
    ...
    \section{Referencias}
        \begin{itemize}
            \item PEP 8 -- Style Guide for Python Code. Python.org. Disponible en: \url{https://peps.python.org/pep-0008/}
            \item PEP 257 -- Docstring Conventions. Python.org. Disponible en: \url{https://peps.python.org/pep-0257/}
            \item SOLID Principles Explained with Examples in Python. Real Python. Disponible en: \url{https://realpython.com/solid-principles-python/}
            \item Danish( 28 May 2026), Principios Solid explicados con ejemplos reales, escueladeprogramación. \url{https://escueladeprogramacion.net/blog/principios-solid-explicados-con-ejemplos-reales}
        \end{itemize}
\end{document}